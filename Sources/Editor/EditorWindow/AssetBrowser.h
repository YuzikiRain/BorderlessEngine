...
namespace BorderlessEditor
{
    ...
    public:
        ...
        void Open()
        {
            ...
            m_CurrentDirectory = std::filesystem::path(assetPath);
        ...
        void Draw()
        {
            ...
            auto relativePath = std::filesystem::relative(m_CurrentDirectory, std::filesystem::path(assetPath).parent_path());
